...
public class LikeController {
  ...
  public ResponseEntity<Void> addLike(@AuthUser User user, @PathVariable Long eventId) {
  ...
  public ResponseEntity<Void> deleteLike(@AuthUser User user, @PathVariable Long eventId) {
